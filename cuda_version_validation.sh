...
PYTORCH_VERSION=$(yq eval '.PYTORCH_VERSION' ./post_reboot.sh)
PYTHON_VERSION=$(yq eval '.PYTHON_VERSION' ./post_reboot.sh)
CUDA_VERSION=$(yq eval '.CUDA_VERSION' ./post_reboot.sh)
